...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO comments (entry_id,date,name,comment) VALUES(" . $validId . ",NOW(),'" . $_POST['name'] . "','" . $_POST['comment'] . "');";
    mysqli_query($db, $sql);
    ...
    $commsql = "SELECT * FROM comments WHERE entry_id = " . $validId . " ORDER BY date DESC;";
